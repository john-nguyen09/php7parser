...
export declare const enum PhraseType {
    ...
    FunctionDeclarationHeader = 86,
    FunctionStaticDeclaration = 87,
    FunctionStaticInitialiser = 88,
    GlobalDeclaration = 89,
    GotoStatement = 90,
    HaltCompilerStatement = 91,
    HeredocStringLiteral = 92,
    Identifier = 93,
    IfStatement = 94,
    IncludeExpression = 95,
    IncludeOnceExpression = 96,
    InlineText = 97,
    InstanceOfExpression = 98,
    InstanceofTypeDesignator = 99,
    InterfaceBaseClause = 100,
    InterfaceDeclaration = 101,
    InterfaceDeclarationBody = 102,
    InterfaceDeclarationHeader = 103,
    InterfaceMemberDeclarationList = 104,
    IssetIntrinsic = 105,
    ListIntrinsic = 106,
    LogicalExpression = 107,
    MemberModifierList = 108,
    MemberName = 109,
    MethodCallExpression = 110,
    MethodDeclaration = 111,
    MethodDeclarationBody = 112,
    MethodDeclarationHeader = 113,
    MethodReference = 114,
    MultiplicativeExpression = 115,
    NamedLabelStatement = 116,
    NamespaceAliasingClause = 117,
    NamespaceDefinition = 118,
    NamespaceName = 119,
    NamespaceUseClause = 120,
    NamespaceUseClauseList = 121,
    NamespaceUseDeclaration = 122,
    NamespaceUseGroupClause = 123,
    NamespaceUseGroupClauseList = 124,
    NullStatement = 125,
    ObjectCreationExpression = 126,
    ParameterDeclaration = 127,
    ParameterDeclarationList = 128,
    PostfixDecrementExpression = 129,
    PostfixIncrementExpression = 130,
    PrefixDecrementExpression = 131,
    PrefixIncrementExpression = 132,
    PrintIntrinsic = 133,
    PropertyAccessExpression = 134,
    PropertyDeclaration = 135,
    PropertyElement = 136,
    PropertyElementList = 137,
    PropertyInitialiser = 138,
    QualifiedName = 139,
    QualifiedNameList = 140,
    RelationalExpression = 141,
    RelativeQualifiedName = 142,
    RelativeScope = 143,
    RequireExpression = 144,
    RequireOnceExpression = 145,
    ReturnStatement = 146,
    ReturnType = 147,
    ScopedCallExpression = 148,
    ScopedMemberName = 149,
    ScopedPropertyAccessExpression = 150,
    ShellCommandExpression = 151,
    ShiftExpression = 152,
    SimpleAssignmentExpression = 153,
    SimpleVariable = 154,
    StatementList = 155,
    StaticVariableDeclaration = 156,
    StaticVariableDeclarationList = 157,
    SubscriptExpression = 158,
    SwitchStatement = 159,
    ThrowStatement = 160,
    TraitAdaptationList = 161,
    TraitAlias = 162,
    TraitDeclaration = 163,
    TraitDeclarationBody = 164,
    TraitDeclarationHeader = 165,
    TraitMemberDeclarationList = 166,
    TraitPrecedence = 167,
    TraitUseClause = 168,
    TraitUseSpecification = 169,
    TryStatement = 170,
    TypeDeclaration = 171,
    UnaryOpExpression = 172,
    UnsetIntrinsic = 173,
    VariableList = 174,
    VariableNameList = 175,
    VariadicUnpacking = 176,
    WhileStatement = 177,
    YieldExpression = 178,
    YieldFromExpression = 179,
}
