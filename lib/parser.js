...
(function (Parser) {
    ...
    function interfaceDeclaration() {
        ...
        p.children.push(p.body = TypeDeclarationBody(102 /* InterfaceDeclarationBody */, isClassMemberStart, interfaceMemberDeclarations));
        return end();
    }
    ...
    function traitDeclaration() {
        ...
        p.children.push(p.body = TypeDeclarationBody(164 /* TraitDeclarationBody */, isClassMemberStart, traitMemberDeclarations));
        return end();
    }
