...
(function (Parser) {
    ...
    function binaryOpToPhraseType(t) {
        switch (t.tokenType) {
            ...
            case 91 /* ForwardSlash */:
            case 92 /* Percent */:
                return 116 /* MultiplicativeExpression */;
            case 113 /* AsteriskAsterisk */:
                return 70 /* ExponentiationExpression */;
            case 106 /* LessThanLessThan */:
            case 108 /* GreaterThanGreaterThan */:
                return 153 /* ShiftExpression */;
            case 102 /* AmpersandAmpersand */:
            case 124 /* BarBar */:
            case 48 /* And */:
            case 49 /* Or */:
            case 50 /* Xor */:
                return 108 /* LogicalExpression */;
            case 138 /* EqualsEqualsEquals */:
            case 140 /* ExclamationEqualsEquals */:
            case 136 /* EqualsEquals */:
            case 139 /* ExclamationEquals */:
            ...
            case 137 /* GreaterThanEquals */:
            case 142 /* Spaceship */:
                return 142 /* RelationalExpression */;
            case 122 /* QuestionQuestion */:
                return 37 /* CoalesceExpression */;
            case 85 /* Equals */:
                return 154 /* SimpleAssignmentExpression */;
            case 112 /* PlusEquals */:
            case 144 /* MinusEquals */:
            case 146 /* AsteriskEquals */:
            case 114 /* AsteriskAsteriskEquals */:
            ...
            case 43 /* InstanceOf */:
                return 99 /* InstanceOfExpression */;
            default:
                return 0 /* Unknown */;
        }
    }
    ...
    function statementList(breakOn) {
        return list(156 /* StatementList */, statement, isStatementStart, breakOn, statementListRecoverSet);
    }
    ...
    function expression(minPrecedence) {
        ...
        while (true) {
            ...
            p.children.push(lhs);
            p.operator = next();
            if (binaryPhraseType === 99 /* InstanceOfExpression */) {
                p.children.push(p.right = typeDesignator(100 /* InstanceofTypeDesignator */));
            }
            else {
                if (binaryPhraseType === 154 /* SimpleAssignmentExpression */ &&
    ...
    function variableOrExpression() {
        ...
        let isVariable = part.phraseType === 155 /* SimpleVariable */;
        ...
        if (t.tokenType === 135 /* PlusPlus */) {
            return postfixExpression(131 /* PostfixIncrementExpression */, part);
        }
        else if (t.tokenType === 129 /* MinusMinus */) {
            return postfixExpression(130 /* PostfixDecrementExpression */, part);
        }
        else {
            return part;
        }
    ...
    function expressionAtom() {
        ...
        switch (t.tokenType) {
            ...
            case 118 /* OpenParenthesis */:
                return variableOrExpression();
            case 135 /* PlusPlus */:
                return unaryExpression(133 /* PrefixIncrementExpression */);
            case 129 /* MinusMinus */:
                return unaryExpression(132 /* PrefixDecrementExpression */);
            case 111 /* Plus */:
            case 143 /* Minus */:
            case 89 /* Exclamation */:
            case 86 /* Tilde */:
                return unaryExpression(173 /* UnaryOpExpression */);
            case 94 /* AtSymbol */:
            ...
            case 35 /* Function */:
                return anonymousFunctionCreationExpression();
            case 41 /* Include */:
                return scriptInclusion(96 /* IncludeExpression */);
            case 42 /* IncludeOnce */:
                return scriptInclusion(97 /* IncludeOnceExpression */);
            case 57 /* Require */:
                return scriptInclusion(145 /* RequireExpression */);
            case 58 /* RequireOnce */:
                return scriptInclusion(146 /* RequireOnceExpression */);
            case 28 /* Eval */:
    ...
    function yieldFromExpression() {
        let p = start({
            phraseType: 180 /* YieldFromExpression */,
            expr: null,
            children: []
        });
        next(); //keyword
    ...
    function yieldExpression() {
        let p = start({
            phraseType: 179 /* YieldExpression */,
            children: []
        });
        next(); //yield
        if (!isExpressionStart(peek())) {
    ...
    function shellCommandExpression() {
        let p = start({
            phraseType: 152 /* ShellCommandExpression */,
    ...
    function dollarCurlyEncapsulatedDimension() {
        let p = start({
            phraseType: 159 /* SubscriptExpression */,
            dereferencable: null,
            offset: null,
            children: []
        });
    ...
    function encapsulatedDimension() {
        ...
        switch (peek().tokenType) {
            ...
            case 143 /* Minus */:
                let u = start({
                    phraseType: 173 /* UnaryOpExpression */,
                    operand: null,
                    operator: null,
                    children: []
                });
    ...
    function encapsulatedProperty() {
        let p = start({
            phraseType: 135 /* PropertyAccessExpression */,
            variable: null,
            memberName: null,
            children: []
        });
    ...
    function heredocStringLiteral() {
        let p = start({
            phraseType: 93 /* HeredocStringLiteral */,
            encapsulatedVariableList: null,
            children: []
        });
        next(); //StartHeredoc
    ...
    function anonymousClassDeclaration() {
        ...
        p.children.push(p.body = typeDeclarationBody(29 /* ClassDeclarationBody */, isClassMemberStart, classMemberDeclarationList));
        return end();
    }
    ...
    function traitUseClause(p) {
        p.phraseType = 169 /* TraitUseClause */;
        next(); //use
    ...
    function traitUseSpecification() {
        let p = start({
            phraseType: 170 /* TraitUseSpecification */,
            children: []
        });
    ...
    function traitAdaptationList() {
        return list(162 /* TraitAdaptationList */, traitAdaptation, isTraitAdaptationStart, [119 /* CloseBrace */]);
    }
    ...
    function traitAdaptation() {
        ...
        if (t.tokenType === 51 /* Namespace */ ||
            ...
            let methodRef = start({
                phraseType: 115 /* MethodReference */,
                methodName: null,
                children: []
            });
    ...
    function traitPrecedence(p) {
        p.phraseType = 168 /* TraitPrecedence */;
    ...
    function methodDeclarationHeader(memberModifers) {
        let p = start({
            phraseType: 114 /* MethodDeclarationHeader */,
            name: null,
            children: []
        }, true);
        if (memberModifers) {
        ...
        if (isParameterStart(peek())) {
            p.children.push(p.parameterList = delimitedList(129 /* ParameterDeclarationList */, parameterDeclaration, isParameterStart, 93 /* Comma */, [121 /* CloseParenthesis */]));
        }
        expect(121 /* CloseParenthesis */);
    ...
    function methodDeclaration(p, memberModifers) {
        p.phraseType = 112 /* MethodDeclaration */;
    ...
    function methodDeclarationBody() {
        let p = start({
            phraseType: 113 /* MethodDeclarationBody */,
            children: []
        });
    ...
    function interfaceDeclaration() {
        let p = start({
            phraseType: 102 /* InterfaceDeclaration */,
            header: null,
            body: null,
            children: []
        });
        p.children.push(p.header = interfaceDeclarationHeader());
        p.children.push(p.body = typeDeclarationBody(103 /* InterfaceDeclarationBody */, isClassMemberStart, interfaceMemberDeclarations));
        return end();
    }
    ...
    function interfaceMemberDeclarations() {
        return list(105 /* InterfaceMemberDeclarationList */, classMemberDeclaration, isClassMemberStart, [119 /* CloseBrace */], classMemberDeclarationListRecoverSet);
    }
    function interfaceDeclarationHeader() {
        let p = start({
            phraseType: 104 /* InterfaceDeclarationHeader */,
            name: null,
            children: []
        });
        next(); //interface
    ...
    function interfaceBaseClause() {
        let p = start({
            phraseType: 101 /* InterfaceBaseClause */,
            nameList: null,
            children: []
        });
        next(); //extends
    ...
    function traitDeclaration() {
        let p = start({
            phraseType: 164 /* TraitDeclaration */,
            header: null,
            body: null,
            children: []
        });
        p.children.push(p.header = traitDeclarationHeader());
        p.children.push(p.body = typeDeclarationBody(165 /* TraitDeclarationBody */, isClassMemberStart, traitMemberDeclarations));
        return end();
    }
    function traitDeclarationHeader() {
        let p = start({
            phraseType: 166 /* TraitDeclarationHeader */,
            name: null,
            children: []
        });
        next(); //trait
    ...
    function traitMemberDeclarations() {
        return list(167 /* TraitMemberDeclarationList */, classMemberDeclaration, isClassMemberStart, [119 /* CloseBrace */], classMemberDeclarationListRecoverSet);
    }
    ...
    function functionDeclarationBody() {
        ...
        cs.phraseType = 86 /* FunctionDeclarationBody */;
        return cs;
    }
    function functionDeclarationHeader() {
        let p = start({
            phraseType: 87 /* FunctionDeclarationHeader */,
            name: null,
            children: []
        });
        next(); //function
    ...
    function switchStatement() {
        let p = start({
            phraseType: 160 /* SwitchStatement */,
            expr: null,
            children: []
        });
        next(); //switch
        ...
        if (tCase.tokenType === 7 /* Case */ || tCase.tokenType === 15 /* Default */) {
            p.children.push(p.caseList = caseStatements(t && t.tokenType === 87 /* Colon */ ?
                25 /* EndSwitch */ : 119 /* CloseBrace */));
        }
        if (t && t.tokenType === 87 /* Colon */) {
            expect(25 /* EndSwitch */);
            expect(88 /* Semicolon */);
        }
        else {
    ...
    function namedLabelStatement() {
        let p = start({
            phraseType: 117 /* NamedLabelStatement */,
            name: null,
            children: []
        });
        p.name = next(); //name
    ...
    function variableList(breakOn) {
        return delimitedList(175 /* VariableList */, variableInitial, isVariableStart, 93 /* Comma */, breakOn);
    }
    function unsetIntrinsic() {
        let p = start({
            phraseType: 174 /* UnsetIntrinsic */,
            variableList: null,
            children: []
        });
        next(); //unset
    ...
    function functionStaticDeclaration() {
        let p = start({
            phraseType: 88 /* FunctionStaticDeclaration */,
            variableDeclarationList: null,
            children: []
        });
        next(); //static
        p.children.push(p.variableDeclarationList = delimitedList(158 /* StaticVariableDeclarationList */, staticVariableDeclaration, isStaticVariableDclarationStart, 93 /* Comma */, [88 /* Semicolon */]));
        expect(88 /* Semicolon */);
        return end();
    }
    function globalDeclaration() {
        let p = start({
            phraseType: 90 /* GlobalDeclaration */,
            variableNameList: null,
            children: []
        });
        next(); //global
        p.children.push(p.variableNameList = delimitedList(176 /* VariableNameList */, simpleVariable, isSimpleVariableStart, 93 /* Comma */, [88 /* Semicolon */]));
        expect(88 /* Semicolon */);
        return end();
    }
    ...
    function staticVariableDeclaration() {
        let p = start({
            phraseType: 157 /* StaticVariableDeclaration */,
            name: null,
            children: []
        });
    ...
    function functionStaticInitialiser() {
        let p = start({
            phraseType: 89 /* FunctionStaticInitialiser */,
            value: null,
            children: []
        });
        next(); //=
    ...
    function returnStatement() {
        let p = start({
            phraseType: 147 /* ReturnStatement */,
            children: []
        });
        next(); //return
        if (isExpressionStart(peek())) {
    ...
    function typeDeclaration() {
        let p = start({
            phraseType: 172 /* TypeDeclaration */,
            name: null,
            children: []
        });
    ...
    function classConstElement() {
        let p = start({
            phraseType: 26 /* ClassConstElement */,
            name: null,
            value: null,
            children: []
        });
    ...
    function propertyDeclaration(p) {
        let t;
        p.phraseType = 136 /* PropertyDeclaration */;
        p.children.push(p.propertyList = delimitedList(138 /* PropertyElementList */, propertyElement, isPropertyElementStart, 93 /* Comma */, [88 /* Semicolon */]));
        expect(88 /* Semicolon */);
        return end();
    }
    function propertyElement() {
        let p = start({
            phraseType: 137 /* PropertyElement */,
            name: null,
            children: []
        });
        p.name = expect(84 /* VariableName */);
    ...
    function propertyInitialiser() {
        let p = start({
            phraseType: 139 /* PropertyInitialiser */,
            value: null,
            children: []
        });
        next(); //equals
    ...
    function memberModifierList() {
        let p = start({
            phraseType: 109 /* MemberModifierList */,
            elements: [],
            children: []
        });
    ...
    function qualifiedNameList(breakOn) {
        return delimitedList(141 /* QualifiedNameList */, qualifiedName, isQualifiedNameStart, 93 /* Comma */, breakOn);
    }
    function objectCreationExpression() {
        let p = start({
            phraseType: 127 /* ObjectCreationExpression */,
            type: null,
            children: []
        });
        next(); //new
            ...
            switch (peek().tokenType) {
                ...
                case 133 /* ColonColon */:
                    let staticPropNode = start({
                        phraseType: 151 /* ScopedPropertyAccessExpression */,
                        scope: part,
                        memberName: null,
                        children: []
                    });
    ...
    function restrictedScopedMemberName() {
        let p = start({
            phraseType: 150 /* ScopedMemberName */,
            name: null,
            children: []
        });
        let t = peek();
    ...
    function parameterDeclaration() {
        let p = start({
            phraseType: 128 /* ParameterDeclaration */,
            name: null,
            children: []
        });
        ...
        while (true) {
            ...
            switch (peek().tokenType) {
                ...
                default:
                    ...
                    if (count === 1 && variableAtomNode.phraseType !== 155 /* SimpleVariable */) {
                        let errNode = start({
    ...
    function scopedAccessExpression(lhs) {
        ...
        if (optional(118 /* OpenParenthesis */)) {
            p.phraseType = 149 /* ScopedCallExpression */;
            if (isArgumentStart(peek())) {
                p.children.push(p.argumentList = argumentList());
            }
            expect(121 /* CloseParenthesis */);
        ...
        else if (p.phraseType === 149 /* ScopedCallExpression */) {
            //error
            error();
        }
        return end();
    ...
    function scopedMemberName(parent) {
        ...
        switch (t.tokenType) {
            case 116 /* OpenBrace */:
                parent.phraseType = 149 /* ScopedCallExpression */;
            ...
            case 84 /* VariableName */:
                ...
                //leaving as a token as this avoids confusion between 
                //static property names and simple variables
                parent.phraseType = 151 /* ScopedPropertyAccessExpression */;
                p.name = next();
                break;
            case 90 /* Dollar */:
                p.children.push(p.name = simpleVariable());
    ...
    function propertyOrMethodAccessExpression(lhs) {
        ...
        if (optional(118 /* OpenParenthesis */)) {
            ...
            p.phraseType = 111 /* MethodCallExpression */;
            expect(121 /* CloseParenthesis */);
        }
        return end();
    }
    ...
    function variadicUnpacking() {
        let p = start({
            phraseType: 177 /* VariadicUnpacking */,
            expr: null,
            children: []
        });
        next(); //...
    ...
    function qualifiedName() {
        ...
        if (t.tokenType === 147 /* Backslash */) {
            ...
            p.phraseType = 143 /* RelativeQualifiedName */;
            next();
    ...
    function simpleVariable() {
        ...
        else if (t && t.tokenType === 84 /* VariableName */) {
            p.name = t;
        }
        return end();
    }
    function haltCompilerStatement() {
        let p = start({ phraseType: 92 /* HaltCompilerStatement */, children: [] });
    ...
    function namespaceUseDeclaration() {
        let p = start({
            phraseType: 123 /* NamespaceUseDeclaration */,
            list: null,
            children: []
        });
        next(); //use
        ...
        if (t.tokenType === 147 /* Backslash */ || t.tokenType === 116 /* OpenBrace */) {
            ...
            expect(147 /* Backslash */);
            expect(116 /* OpenBrace */);
            p.children.push(p.list = delimitedList(125 /* NamespaceUseGroupClauseList */, namespaceUseGroupClause, isNamespaceUseGroupClauseStartToken, 93 /* Comma */, [119 /* CloseBrace */]));
            return end();
        }
        p.children.push(p.list = delimitedList(122 /* NamespaceUseClauseList */, namespaceUseClauseFunction(nsNameNode), isQualifiedNameStart, 93 /* Comma */, [88 /* Semicolon */]));
        expect(88 /* Semicolon */);
        return end();
    }
    function namespaceUseClauseFunction(nsName) {
        return () => {
            let p = start({
                phraseType: 121 /* NamespaceUseClause */,
                name: null,
                children: []
            }, !!nsName);
            if (nsName) {
    ...
    function namespaceUseGroupClause() {
        let p = start({
            phraseType: 124 /* NamespaceUseGroupClause */,
            name: null,
            children: []
        });
        p.kind = optionalOneOf([35 /* Function */, 12 /* Const */]);
    ...
    function namespaceAliasingClause() {
        let p = start({
            phraseType: 118 /* NamespaceAliasingClause */,
            alias: null,
            children: []
        });
        next(); //as
    ...
    function namespaceDefinition() {
        let p = start({
            phraseType: 119 /* NamespaceDefinition */,
            children: []
        });
        next(); //namespace
